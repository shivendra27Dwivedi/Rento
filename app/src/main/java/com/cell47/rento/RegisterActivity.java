...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText et_username, et_password,et_phone, et_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    et_email.setError("Please provide your email address");
                }
                else {
                    ...
                    if (isNetworkAvailable(RegisterActivity.this)){
                        ...
                        alertdialog.setTitle("Terms and conditions Apply");
                        alertdialog.setMessage("For Proceeding further you have agree on our terms and conditions. Please check them carefully...");
    ...
    private void saveData() {
        ...
        editor.putString("Liked", "0");
        editor.putString("Published", "0");
        editor.apply();
