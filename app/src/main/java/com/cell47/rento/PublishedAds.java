...
public class PublishedAds extends AppCompatActivity implements RewardedVideoAdListener {
    ...
    FloatingActionButton bmaps;
    private DatabaseReference mDataBaseRefadmin;
    private String userChoosenTask;
    TextView tvpnum,tvcity, email;
    private Button b1,b2,b3, add, logout;
    String refkey;
    ...
    TextView tvusername, coins, liked, posted;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference().child("users").child(sharedPreferences.getString("phone", null)).child("Liked").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        FirebaseDatabase.getInstance().getReference().child("users").child(sharedPreferences.getString("phone", null)).child("Published").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String str = dataSnapshot.getValue(String.class);
                posted.setText(str);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                Intent intent = new Intent(PublishedAds.this, LoginActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
                //startActivity(new Intent(PublishedAds.this, LoginActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                finish();
            }
        });
        ...
        EditProf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PublishedAds.this, UpdateProfile.class);
                i.putExtra("shared", sharedPreferences.getString("phone","1234567890"));
                startActivity(i);
                finish();
            }
        });
    ...
    private void setName() {
        ...
        FirebaseDatabase.getInstance().getReference().child("users").child(sharedPreferences.getString("phone",null))
                .child("mobile").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    tvpnum.setText(dataSnapshot.getValue(String.class));
                    editor.putString("mobile",dataSnapshot.getValue(String.class));
                    editor.apply();
                }
            }
                        ...
                        progressBar2.setVisibility(View.GONE);
                            ...
                            viewHolder.bsold.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    AlertDialog.Builder alertBuilder =new AlertDialog.Builder(PublishedAds.this);
                                    final AlertDialog alertDialog;
                                    alertDialog = alertBuilder.create();
                                    alertBuilder.setTitle("Are you sure to remove the Ad ?");
                                    alertBuilder.setIcon(R.drawable.rento);
                                    alertBuilder.setMessage("This will delete your ad from the list");
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(PublishedAds.this);
                                            builder.setPositiveButton(Integer.parseInt("Yes,Delete Ad"),
