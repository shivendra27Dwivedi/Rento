    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(AdUploaded.this);
                    builder.setTitle("Account is required.");
                    builder.setMessage(R.string.register)
                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    startActivity(new Intent(AdUploaded.this, RegisterActivity.class));
                                }
                            })
